        ...
        <div class="container-fluid px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-lg-4">
                    <li class="nav-item"><a class="nav-link" aria-current="page" href="index.php">ยี่ห้อ</a></li>
                    <li class="nav-item"><a class="nav-link" aria-current="page" href="View/view_add.php">เพิ่มรุ่นโทรศัพท์</a></li>
                </ul>
            </div>
